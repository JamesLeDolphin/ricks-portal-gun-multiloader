...
public class PGDataComponents {
    ...
    public static final DataComponentType<ResourceLocation> GUN_MODEL = registerComponent("gun_model", typeBuilder -> typeBuilder.persistent(ResourceLocation.CODEC));
