...
public class PGJeiPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<PortalGunWorkbenchRecipe> recipeList = manager.getAllRecipesFor(PGRecipeTypes.WORKBENCH_TYPE);
        if (!recipeList.isEmpty()) registration.addRecipes(TYPE, recipeList);
    }
