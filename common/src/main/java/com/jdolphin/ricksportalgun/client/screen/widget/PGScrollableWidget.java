...
public abstract class PGScrollableWidget<E extends PGScrollableWidget.Entry<E>> extends AbstractSelectionList {
    ...
    protected void renderListBackground(GuiGraphics guiGraphics) {
        ...
        guiGraphics.blit(resourcelocation, this.getX(), this.getY(), (float)this.getRight(), (float)(this.getBottom() + (int)this.getScrollAmount()), this.getWidth(), this.getHeight(), 32, 32);
        RenderSystem.disableBlend();
    }
    ...
    public void setClampedScrollAmount(double scroll) {
        this.scrollAmount = Mth.clamp(scroll, 0.0F, this.getMaxScroll());
    }
